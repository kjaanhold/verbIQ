...
def tests_summary():
    ...
    if not TestResults.query.filter_by(lapse_eesnimi = name.lower()).first():
      ...
      if (data_jah != 'no_results' and data_ei == 'no_results'):
        out_text = u"Tänan! " + name + u" on omandanud kõik " + data_jah + " peamist oskust, mida selles vanuses lapse arengu hindamisel jälgitakse."
        ...
        out_text = u"Tänan! " + name + u" on juba omadanud " + data_jah + " lapse arengus jälgitavat oskust. " + name + u" õpib praegu veel: "+ data_ei + " oskust."
        ...
        out_text = u"Tänan! " + name + u" praegu veel õpib " + data_ei + " peamist eakohast oskust."
